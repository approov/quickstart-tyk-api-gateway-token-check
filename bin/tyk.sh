...
Show_Help() {
  ...
  api-setup               Creates and configures a new API for httpbin.org:
                          ./tyk api-setup
  ...
  create-api              Creates an API configuration:
                          ./tyk create-api

  get-security-policy     Get a security policy by ID:
                          ./tyk get-security-policy
                          ./tyk get-security-policy approov

  create-security-policy  Creates the Approov security policy:
                          ./tyk create-security-policy

  reload                  Reloads the Tyk API Gateway:
                          ./tyk reload

  up                      Brings up the docker stack for Tyk and Redis:
                          ./tyk up
                          ./tyk up --detach

  down                    Brings donw the docker stack for Tyk and Redis:
                          ./tyk down

  logs                    Tails the docker stack logs:
                          ./tyk logs --follow
                          ./tyk logs --follow tyk-gateway
                          ./tyk logs --follow tyk-redis
